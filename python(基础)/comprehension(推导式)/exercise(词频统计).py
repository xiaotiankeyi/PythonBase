...
path = r"C:\Users\admin\Downloads\Walden.txt"

with open(path, 'r+', encoding='utf8') as f:
    words = [rad_word.strip(string.punctuation).lower() for rad_word in f.read().split()]
    """转化为集合去重复操作"""
...
def sum():
    with open("C:\\Users\\admin\\Downloads\\Walden.txt", "r", encoding='utf8') as a:
        collection = []
