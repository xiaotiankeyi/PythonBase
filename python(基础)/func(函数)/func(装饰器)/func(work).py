...
def handle(file_1):
    ...
    with open(file_1, 'r') as g:
        for i in g:
            ...
            for v in msg:
                c = v.split()
            goods_collection = {"name": c[0], "sex": c[1], "age": c[2], "salary": c[3]}
        ...
        def maximum():
            ...
            def minimum():
                ...
                def strip():
                    info_new = map(lambda shop_collection: {'name': shop_collection['name'].capitalize(),
                                                            'sex': shop_collection['sex'],
                                                            'age': shop_collection['age'],
                                                            'salary': shop_collection['salary']}, shop_collection)
                    # li = []       #第二种写法
                    # for i in f:
