...
time.sleep(2)
# os.removedirs(r"C:/Users/admin/PycharmProjects/python/python(模块)/os(路径模块)/dirname1/dirname2")
...
"""获取目录下的所有文件及目录"""
print(os.listdir(r"C:\Users\admin\PycharmProjects\python_study\python(模块)"))

"""获取文件目录信息"""
print(os.stat(r"C:\Users\admin\PycharmProjects\python_study\python(模块)"))
...
"""返回path最后的文件名"""
g = os.path.basename("C:/Users/admin/PycharmProjects/python/python(基础)")
print(g)

"""目录路径拼接,将多个路径组合后返回"""
f = r"C:Users\admin\PycharmProjects\python_study"
h = r"python(模块)\os(路径模块)\python(os模块).py"
y = os.path.join(f, h)
print(y)
